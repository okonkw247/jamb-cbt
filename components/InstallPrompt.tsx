  ...
  if (isIphone) return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-end justify-center z-50 px-4 pb-6">
      <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl">
        ...
        <p className="text-gray-600 text-sm mb-4">Follow these 3 steps to install on your iPhone:</p>
        ...
        <button onClick={handleSkip} className="w-full bg-gray-100 text-gray-500 py-3 rounded-2xl font-medium text-sm">
          I'll do it later
        </button>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-end justify-center z-50 px-4 pb-6">
      <div className="bg-white rounded-3xl p-6 w-full max-w-sm shadow-2xl">
        ...
        <button onClick={handleInstall} className="block w-full bg-green-500 text-white py-4 rounded-2xl font-bold text-lg text-center mb-3">
          📲 Install App
        </button>
        <button onClick={handleSkip} className="block w-full text-gray-400 text-sm text-center py-2">
          Not now
        </button>
      </div>
    </div>
