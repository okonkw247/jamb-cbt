            ...
            <div className="fixed bottom-36 right-4 rounded-2xl shadow-2xl p-4 z-50 w-72">
              ...
              <div className="grid grid-cols-4 gap-1.5">
                {[
                  ...
                  ["7", () => calcNumber("7"), "bg-[#374151] text-white"],
                  ["8", () => calcNumber("8"), "bg-[#374151] text-white"],
                  ["9", () => calcNumber("9"), "bg-[#374151] text-white"],
                  ["×", () => calcOperator("*"), "bg-orange-400 text-white"],
                  ["4", () => calcNumber("4"), "bg-[#374151] text-white"],
                  ["5", () => calcNumber("5"), "bg-[#374151] text-white"],
                  ["6", () => calcNumber("6"), "bg-[#374151] text-white"],
                  ["−", () => calcOperator("-"), "bg-orange-400 text-white"],
                  ["1", () => calcNumber("1"), "bg-[#374151] text-white"],
                  ["2", () => calcNumber("2"), "bg-[#374151] text-white"],
                  ["3", () => calcNumber("3"), "bg-[#374151] text-white"],
                  ["+", () => calcOperator("+"), "bg-orange-400 text-white"],
                  ["0", () => calcNumber("0"), "bg-[#374151] text-white col-span-2"],
                  [".", () => { if (!calcDisplay.includes(".")) { setCalcDisplay(calcDisplay+"."); setCalcExpression(calcExpression+"."); }}, "bg-[#374151] text-white"],
